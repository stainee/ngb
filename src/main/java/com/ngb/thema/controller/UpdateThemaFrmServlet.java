 ...
 */
@WebServlet(name = "UpdateThemaFrm", urlPatterns = { "/updateThemaForm.do" })
public class UpdateThemaFrmServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Thema t = service.getThema(themaCode);
		//4. 결과처리
		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/thema/updateThemaFrm.jsp");
