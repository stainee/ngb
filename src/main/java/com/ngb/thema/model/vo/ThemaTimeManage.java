...
public class ThemaTimeManage {
   ...
   public ThemaTimeManage() {
      super();
      // TODO Auto-generated constructor stub
   }
   public ThemaTimeManage(String themaCode, String category, String themaName, String themaContent, int devicePer,
         int lockPer, int peopleMin, int peopleMax, int themaLevel, int themaPrice, String themaFilepath,
         int themaTime, String time, String timeCode) {
      super();
